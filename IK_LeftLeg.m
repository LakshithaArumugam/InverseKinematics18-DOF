...
%Get forward transformation from Torso to Left Hand
tformRH = getTransform(boiloid,randConfig,'L9L','base')
...
[configSoln, solnInfo] = step(ik, 'L9L', tformRH, weights,initialguess );
